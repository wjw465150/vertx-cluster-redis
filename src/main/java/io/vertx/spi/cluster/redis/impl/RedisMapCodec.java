  ...
  private final Encoder encoder = new Encoder() {
    ...
    public ByteBuf encode(Object in) throws IOException {
      ...
      try {
        ...
        log.warn(MessageFormat.format("in.class: {0}, error: {1}", in == null ? "<null>" : in.getClass().getName(), e.toString()));
        out.release();
        throw e;
      }
    }
  ...
  private final Decoder<Object> decoder = new Decoder<Object>() {
    ...
    public Object decode(ByteBuf buf, State state) throws IOException {
      ...
      try (DataInputStream in = new DataInputStream(byteIn)) {
        ...
        log.warn(MessageFormat.format("buf.class: {0}, state: {1}, error: {2}", buf.getClass().getName(), state, e.toString()));
        buf.release();
